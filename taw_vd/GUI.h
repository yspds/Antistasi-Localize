...
class TawRscShortcutButton {
	...
	animTextureDefault = "\A3\ui_f\data\GUI\RscCommon\TawRscShortcutButton\normal_ca.paa";
	animTextureNormal = "\A3\ui_f\data\GUI\RscCommon\TawRscShortcutButton\normal_ca.paa";
	animTextureDisabled = "\A3\ui_f\data\GUI\RscCommon\TawRscShortcutButton\normal_ca.paa";
	animTextureOver = "\A3\ui_f\data\GUI\RscCommon\TawRscShortcutButton\over_ca.paa";
	animTextureFocused = "\A3\ui_f\data\GUI\RscCommon\TawRscShortcutButton\focus_ca.paa";
	animTexturePressed = "\A3\ui_f\data\GUI\RscCommon\TawRscShortcutButton\down_ca.paa";
	periodFocus = 1.2;
	periodOver = 0.8;
	class HitZone
	{
...
class TawRscControlsGroupNoScrollbars : TawRscControlsGroup {
...
class TawRscButtonMenu:TawRscShortcutButton {
	idc = -1;
	type = 16;
	style = "0x02 + 0xC0";
	default = 0;
...
class TAW_VDMenu {
	...
	class controls {
		...
		//Sliders
		class VD_onFoot_slider : TawRscXSliderH {
			idc = INFANTRY_SLIDER;
			text = "";
		...
		class Manager:TawRscControlsGroup {
			...
			w = .5; h = 3;
			class Controls {
				class SaveLoadGroup:TawRscControlsGroupNoScrollbars {
					idc = SAVELOAD_GROUP;
