...
if (!isNull _selectable) then
	{
	if (_disconnected) then {_texto = format ["玩家指挥官下线或辞退. %1 是我们的新指挥官. 欢迎他!", name _selectable]} else {_texto = format ["%1 不再担任指挥官.\n\n %2 使我们的新指挥官. 欢迎他!", name theBoss, name _selectable]};
